...
int cmd_get_flash_protection(cskburn_serial_device_t *dev, uint32_t *protection);
...
int cmd_emmc_get_info(cskburn_serial_device_t *dev, emmc_info_t *info);
